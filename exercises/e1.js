...
function logMessageWithMyName (personOne) {
  console.log("My name is " + personOne + "!");
}
...
function logMyInfo(personTwo, age) {
  console.log("My name is " + personTwo + ". I am " + age + " years old!");
}
